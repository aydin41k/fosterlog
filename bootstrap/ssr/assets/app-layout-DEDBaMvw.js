...
import { XIcon, PanelLeftIcon, X, Settings, LogOut, ChevronsUpDown, House, Heart, ChevronRight } from "lucide-react";
import { c as cn, B as Button, q as queryParams } from "./index-WFXEz8te.js";
...
const SidebarMenuButton = React.forwardRef(function SidebarMenuButton2({
  asChild = false,
  isActive = false,
  variant = "default",
  size = "default",
...
function Toast({ title, description, variant = "default", onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: `fixed top-4 right-4 z-50 max-w-sm p-4 rounded-lg shadow-lg ${bgColor} ${textColor}`, children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ jsx("h4", { className: "font-semibold", children: title }),
      description && /* @__PURE__ */ jsx("p", { className: "text-sm opacity-90 mt-1", children: description })
    ] }),
    /* @__PURE__ */ jsx(
      Button,
      {
...
function ToastContainer() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed top-0 right-0 z-50 p-4 space-y-2", children: toasts.map((toast) => /* @__PURE__ */ jsx(
    Toast,
    {
      title: toast.title,
...
function AppContent({ variant = "header", children, ...props }) {
  if (variant === "sidebar") {
    return /* @__PURE__ */ jsxs(SidebarInset, { ...props, children: [
      children,
      /* @__PURE__ */ jsx(ToastContainer, {})
    ] });
  }
  return /* @__PURE__ */ jsxs("main", { className: "mx-auto flex h-full w-full max-w-7xl flex-1 flex-col gap-4 rounded-xl", ...props, children: [
    children,
    /* @__PURE__ */ jsx(ToastContainer, {})
  ] });
}
...
function NavFooter({
  ...
  return /* @__PURE__ */ jsx(SidebarGroup, { ...props, className: `group-data-[collapsible=icon]:p-0 ${className || ""}`, children: /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(
    SidebarMenuButton,
    {
      ...
      children: /* @__PURE__ */ jsxs("a", { href: typeof item.href === "string" ? item.href : item.href.url, target: "_blank", rel: "noopener noreferrer", children: [
...
function UserMenuContent({ user }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(DropdownMenuSeparator, {}),
    /* @__PURE__ */ jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxs(Link, { className: "block w-full", href: logout(), as: "button", onClick: handleLogout, children: [
...
function AppSidebar() {
  return /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", variant: "inset", children: [
    /* @__PURE__ */ jsx(SidebarHeader, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { size: "lg", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: animals.index().url, prefetch: true, children: /* @__PURE__ */ jsx(AppLogo, {}) }) }) }) }) }),
